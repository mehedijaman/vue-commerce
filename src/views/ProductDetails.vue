<script setup>
	...
	async function getProduct(){
		Object.assign(product, await ApiService.getProduct(id));
	}
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 gallery-holder">
							<div class="product-item-holder size-big single-product-gallery small-gallery">
								<!-- <div id="owl-single-product">
									<div v-for="(image, index) in product.images" :key="index" class="single-product-gallery-item" :id="`slider-${product.id}`">
								...
								<!-- <div class="single-product-gallery-thumbs gallery-thumbs">
									<div id="owl-single-product-thumbnails">
										<div v-for="(image, index) in product.images" :key="index" class="item">
											<a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" :href="`#slider-${product.id}`">
												<img class="img-responsive" alt="" :src="image" :data-echo="image" />
											</a>
										</div>
									</div>
							...
							<div class="product-info">
								...
								<div class="rating-reviews m-t-20">
									...
									<div class="col-lg-12">
										...
										<div class="pull-left">
											<div class="reviews">
												<a href="#" class="lnk">(Rating {{ product.rating }})</a>
											</div>
										</div>
										</div>
									</div>	
								...
								<div class="stock-container info-container m-t-10">
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="pull-left">
												<div class="stock-box">
													<span class="value">{{ product.stock > 0? 'In Stock' : 'Out of Stock' }}</span>
												</div>	
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-6 col-xs-6">
											<div class="price-box">
												...
												<span class="price-strike">${{ Math.round(product.price + (product.price*product.discountPercentage)/100) }}</span>
											</div>
										</div>
